...
- **Сообщение-заглушка при проверке**: При обнаружении потенциального сообщения о парковке сначала отправляется сообщение "⏳ Проверяю сообщение...", которое затем заменяется на основное сообщение с розыгрышем или удаляется, если сообщение не о свободном месте
...
- Сообщение-заглушка заменяется на основное сообщение с кнопкой через `edit_message_text` для лучшего UX
